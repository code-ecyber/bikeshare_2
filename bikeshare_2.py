...
def get_filters():
    ...
    while True:
        city = input('Please enter city, either washington, chicago, or new york city: ')
...
def station_stats(df):
    ...
    common_st_station = df['Start Stations'].mode()[0]
...
def user_stats(df):
    ...
    print('The counts of gender are', gender_type)
    ...
    print('The most recent birth year is', birth_year_min)
